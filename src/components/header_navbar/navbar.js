...
const styles2={
    ...
    return (
        ...
        <>
            <div className="w-nav-overlay menu ng-trigger ng-trigger-slideInOut" style={isStyle}>
                <nav className="nav-menu w-nav-menu nav-menu-bg" role="navigation">
                    <app-menu className="ng-tns-c2-0">
